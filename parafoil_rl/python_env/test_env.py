...
# ── Windows DLL fix ────────────────────────────────────────────────────────
# MUST be before ALL other imports. Python 3.8+ does not search PATH for DLLs.
import os
import sys
...
_python_env = Path(__file__).parent.resolve() / "python_env"
...
def test_gym_wrapper():
    ...
    print("  PASS: Gymnasium wrapper OK")


def test_episode():
    """Run a full episode to ground."""
    print("\n" + "=" * 50)
    print("Test 3: Full episode (zero brake policy)")
    print("=" * 50)
